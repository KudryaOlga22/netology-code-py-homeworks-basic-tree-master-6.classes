class Student:
    def __init__(self, name, surname):
        """Метод _init_ для определения атрибутов класса Student содержит атрибуты:
        self.name = name
    ...
    def __str__(self):
        """Определяет среднюю оценку и возвращает характеристики экземпляра класса вида:
        print(some_student)
        Имя: Ruoy
        Фамилия: Eman
    ...
    def rate_hw(self, lecturer, course, grade):
        """Предоставляет возможность выставления оценки лектору студентом, если это лектор ведет лекции по данному курсу у этого студента
    ...
    def __lt__(self, other):
        """Сравнивает через операторы '<,>' студентов между собой по средней оценке за домашние задания"""
...
class Lecturer(Mentor):
    ...
    def __lt__(self, other):
        """Сравнивает через операторы '<,>' лекторов между собой по средней оценке за лекции"""
